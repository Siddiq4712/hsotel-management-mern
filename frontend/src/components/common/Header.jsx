          ...
          <div className="flex items-center gap-3 pl-2 border-l border-slate-100 lg:border-slate-200">
            <div className="text-right hidden sm:block">
              ...
              <p className="text-[11px] text-slate-400 mt-1 italic">
                {user?.hostel?.name || 'Central MGMT'}
              </p>
            </div>
            
            <div className="h-10 w-10 rounded-xl bg-gradient-to-br from-slate-100 to-slate-200 border border-slate-200 flex items-center justify-center text-blue-600 font-bold">
